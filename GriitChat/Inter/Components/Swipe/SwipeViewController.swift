...
open class SwipeViewController: UINavigationController, UIPageViewControllerDelegate, UIScrollViewDelegate, Navigation, BarButtonItem, SwipeButton, SelectionBar {
    ...
    var scrollDelegate: SwipeViewControllerDelegate?;
    ...
    open func setSwipeViewController() {
        ...
        navView.navigationView.isHidden = true;
        pageController.navigationController?.navigationBar.isHidden = true;
    }
    ...
    open func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        scrollDelegate?.onDidScroll(fromCenterX: xFromCenter, currentIndex: currentPageIndex);
    ...
    func allowToMove(isAllow: Bool) {
        self.pageScrollView.isPagingEnabled = isAllow;
        self.pageScrollView.isScrollEnabled = isAllow;
    }
}
